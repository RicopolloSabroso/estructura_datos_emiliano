...
public class SegundoP {
	...
	public static void main(String[] args)throws Exception  {
		...
		LinkedQueue copiaConsonantes=new LinkedQueue();
		LinkedQueue copiaVocales=new LinkedQueue();
		vocalesConsonantes(colaVocales,copiaVocales);
//		System.out.println(colaVocales);
//		System.out.println(colaConsonantes);
//		System.out.println("vocales");
//		contar(colaVocales,copiaVocales);
//		System.out.println("consonantes ");
//		contar( colaConsonantes,copiaConsonantes);
//		Ejercicio 2
...
//		cuartaPregunta();
	...
	private static void vocalOConsonante(String palabra, LinkedQueue colaVocales, LinkedQueue colaConsonantes) {
	...
	public static void contar(String tipo, CircularQueue cola) {
